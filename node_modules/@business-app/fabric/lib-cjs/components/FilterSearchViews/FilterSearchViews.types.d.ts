...
export declare type IRetrieveFilterButtonIconName = (selectedFilterKey: string | null) => string;
...
export declare type IFilterSearchViewsStyleProps = Required<Pick<IFilterSearchViewsProps, 'theme'>>;

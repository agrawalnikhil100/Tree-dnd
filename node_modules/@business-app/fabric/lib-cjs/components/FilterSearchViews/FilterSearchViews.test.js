...
describe('FilterSearchViews', function () {
    it('calls shouldFilterItem for every item', function () {
        ...
        var wrapper = enzyme_1.mount(React.createElement(index_1.FilterSearchViewsBase, { items: flatItems, shouldFilterItem: shouldFilterItemFn, views: [{ key: 'test', iconName: '', text: 'Test', onRenderView: function () { return null; } }], strings: strings }));
    ...
    it('calls onRenderView for the selected view', function () {
        ...
        var wrapper = enzyme_1.mount(React.createElement(index_1.FilterSearchViewsBase, { items: flatItems, shouldFilterItem: function () { return true; }, views: [
        ...
        var viewsButton = wrapper.find(Button_1.IconButton);
    ...
    it('calls onRenderView with correct information', function () {
        ...
        var wrapper = enzyme_1.mount(React.createElement(index_1.FilterSearchViewsBase, { items: flatItems, shouldFilterItem: function () { return true; }, views: [{ key: 'one', iconName: '', text: 'One', onRenderView: viewRenderFn }], filters: filters, strings: strings }));
        expect(viewRenderFn).toHaveBeenCalledTimes(1);
        expect(viewRenderFn).toHaveBeenLastCalledWith(flatItems, '', null);
        var searchBox = wrapper.find(FilterSearchBox_1.FilterSearchBox);
    ...
    it('provides views picker IconButton correct props based on views count', function () {
        ...
        var wrapper = enzyme_1.mount(React.createElement(index_1.FilterSearchViewsBase, { items: flatItems, shouldFilterItem: function () { return true; }, views: views, strings: strings }));
        ...
        viewsButton = wrapper.find(Button_1.IconButton);
        expect(viewsButton.length).toBe(1);
    ...
    it('updates selectedViewKey to defaultValue when view is removed', function () {
        ...
        var wrapper = enzyme_1.mount(React.createElement(index_1.FilterSearchViewsBase, { items: flatItems, shouldFilterItem: function () { return true; }, views: views, strings: strings, defaultSelectedViewKey: 'two' }));
        expect(getState(wrapper).selectedViewKey).toBe('two');
        var viewsButton = wrapper.find(Button_1.IconButton);
    ...
    it('calls onRenderView with only the filtered items', function () {
        ...
        var wrapper = enzyme_1.mount(React.createElement(index_1.FilterSearchViewsBase, { items: flatItems, shouldFilterItem: function (item) { return item.value !== 2; }, views: [{ key: 'test', iconName: '', text: 'Test', onRenderView: renderViewFn }], strings: strings }));
    ...
    it('calls onRenderView with only the filtered partial nested items', function () {
        var renderViewFn = jest.fn();
        var wrapper = enzyme_1.mount(React.createElement(index_1.FilterSearchViewsBase, { items: nestedItems, shouldFilterItem: function (item) { return item.value !== 11; }, views: [{ key: 'test', iconName: '', text: 'Test', onRenderView: renderViewFn }], strings: strings }));
    ...
    it('calls onRenderView with empty groups removed', function () {
        var renderViewFn = jest.fn();
        var wrapper = enzyme_1.mount(React.createElement(index_1.FilterSearchViewsBase, { items: nestedItems, shouldFilterItem: function (item) {
                if (item.children) {
    ...
    it('calls shouldFilterItem with correct search and filter information', function () {
        var shouldFilterItemFn = jest.fn();
        var wrapper = enzyme_1.mount(React.createElement(index_1.FilterSearchViewsBase, { items: flatItems, shouldFilterItem: shouldFilterItemFn, views: [{ key: 'test', iconName: '', text: 'Test', onRenderView: function () { return null; } }], filters: [{ key: 'a', text: 'A' }], strings: strings }));
        expect(shouldFilterItemFn).toHaveBeenLastCalledWith(flatItems[1], '', null);
        var filterSearchBox = wrapper.find(FilterSearchBox_1.FilterSearchBox);
    ...
    it('updates all filter text correctly when strings allItemFilterText changes', function () {
        var wrapper = enzyme_1.mount(React.createElement(index_1.FilterSearchViewsBase, { items: flatItems, shouldFilterItem: function () { return true; }, views: [{ key: 'test', iconName: '', text: 'Test', onRenderView: function () { return null; } }], strings: {
                searchBoxPlaceholder: '',
        ...
        filterSearchBox = wrapper.find(FilterSearchBox_1.FilterSearchBox);
        expect(filterSearchBox.length).toBe(1);
    ...
    it('updates filters list when props change', function () {
        ...
        var wrapper = enzyme_1.mount(React.createElement(index_1.FilterSearchViewsBase, { items: flatItems, shouldFilterItem: function () { return true; }, views: [{ key: 'test', iconName: '', text: 'Test', onRenderView: function () { return null; } }], filters: [aFilter], strings: {
                searchBoxPlaceholder: '',
                allItemsFilterItemText: 'All'
            } }));
        var filterSearchBox = wrapper.find(FilterSearchBox_1.FilterSearchBox);
    ...
    it('focuses search box when focus is called on componentRef', function () {
        ...
        var wrapper = enzyme_1.mount(React.createElement(index_1.FilterSearchViewsBase, { componentRef: ref, items: flatItems, shouldFilterItem: function () { return true; }, views: [{ key: 'test', iconName: '', text: 'Test', onRenderView: function () { return null; } }], strings: strings }));
    ...
    it('throws an error with cirular references in items', function () {
        ...
        var ErrorBoundary = /** @class */ (function (_super) {
            ...
            ErrorBoundary.prototype.render = function () {
                return (React.createElement(index_1.FilterSearchViewsBase, { items: [item1, item2], shouldFilterItem: function () { return true; }, views: [{ key: 'test', iconName: '', text: 'Test', onRenderView: function () { return null; } }], strings: strings }));
            };
        ...
        var wrapper = enzyme_1.mount(React.createElement(ErrorBoundary, null));
        // eslint-disable-next-line no-console
    ...
    it('handles default state props as expected', function () {
        ...
        var wrapper = enzyme_1.mount(React.createElement(index_1.FilterSearchViewsBase, { strings: strings, items: flatItems, shouldFilterItem: function () { return true; }, views: views, filters: filters, defaultSearchText: defaultSearchText, defaultSelectedFilterKey: defaultFilterKey, defaultSelectedViewKey: defaultViewKey }));
    ...
    it('calls onChange functions when values change', function () {
        ...
        var wrapper = enzyme_1.mount(React.createElement(index_1.FilterSearchViewsBase, { items: flatItems, shouldFilterItem: function () { return true; }, views: views, filters: filters, strings: strings, onChangeSearchText: onChangeSearchText, onChangeFilter: onChangeFilter, onChangeView: onChangeView }));
        var filterSearchBox = wrapper.find(FilterSearchBox_1.FilterSearchBox);
        expect(filterSearchBox.length).toBe(1);
        var viewsButton = wrapper.find(Button_1.IconButton);
        expect(viewsButton.length).toBe(1);
    ...
    it('sends filterButtonIconName prop correctly to FilterSearchBox', function () {
        var wrapper = enzyme_1.mount(React.createElement(index_1.FilterSearchViewsBase, { items: flatItems, shouldFilterItem: function () { return true; }, views: [{ key: 'test', iconName: '', text: 'Test', onRenderView: function () { return null; } }], strings: strings, filterButtonIconName: 'Some icon name' }));
        var searchBox = wrapper.find(FilterSearchBox_1.FilterSearchBox);
        expect(searchBox.length).toBe(1);
        ...
        searchBox = wrapper.find(FilterSearchBox_1.FilterSearchBox);
        expect(searchBox.length).toBe(1);
    ...
    it('filterButtonIconName is called appropriately based on selected filter', function () {
        ...
        var wrapper = enzyme_1.mount(React.createElement(index_1.FilterSearchViewsBase, { items: flatItems, filters: filters, shouldFilterItem: function () { return true; }, views: [{ key: 'test', iconName: '', text: 'Test', onRenderView: function () { return null; } }], strings: strings, filterButtonIconName: filterButtonIconFn }));
    ...
    it('defaultFilterIconNameFunction functions correctly', function () {
        ...
        var wrapper = enzyme_1.mount(React.createElement(index_1.FilterSearchViewsBase, { items: flatItems, filters: filters, shouldFilterItem: function () { return true; }, views: [{ key: 'test', iconName: '', text: 'Test', onRenderView: function () { return null; } }], strings: strings, filterButtonIconName: index_1.defaultFilterIconNameFunction }));
        expect(wrapper.find(FilterSearchBox_1.FilterSearchBox).prop('filterButtonIconName')).toBe('Filter');
        getInstance(wrapper).setState({ selectedFilterKey: filters[0].key });
        wrapper.update();
        expect(wrapper.find(FilterSearchBox_1.FilterSearchBox).prop('filterButtonIconName')).toBe('FilterSolid');
        getInstance(wrapper).setState({ selectedFilterKey: filters[1].key });
        wrapper.update();
        expect(wrapper.find(FilterSearchBox_1.FilterSearchBox).prop('filterButtonIconName')).toBe('FilterSolid');
    ...
    it('sends strings appropriately to FilterSearchBox', function () {
        var wrapper = enzyme_1.mount(React.createElement(index_1.FilterSearchViewsBase, { items: flatItems, shouldFilterItem: function () { return true; }, views: [{ key: 'test', iconName: '', text: 'Test', onRenderView: function () { return null; } }], strings: tslib_1.__assign(tslib_1.__assign({}, strings), { searchBoxPlaceholder: 'Search box placeholder', searchBoxClearButtonTitle: 'Clear search tooltip', filterButtonTooltipText: 'Filter button tooltip' }) }));
        var searchBox = wrapper.find(FilterSearchBox_1.FilterSearchBox);
        expect(searchBox.length).toBe(1);
    ...
    it('fills a componentRef', function () {
        ...
        var wrapper = enzyme_1.mount(React.createElement(index_1.FilterSearchViewsBase, { componentRef: _filterSearchViewsRef, items: nestedItems, shouldFilterItem: function (item) {
                if (item.children) {
                    return item.children.length > 0;
                }
                return item.value < 20;

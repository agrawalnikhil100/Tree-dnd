...
exports.FilterSearchViewsGroupedDataExample = void 0;
...
var FilterSearchViewsGroupedDataExample = /** @class */ (function (_super) {
    tslib_1.__extends(FilterSearchViewsGroupedDataExample, _super);
    ...
    FilterSearchViewsGroupedDataExample.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(index_1.FilterSearchViews, { strings: {
                ...
                }, items: FilterSearchViewsExampleData_1.groupedItems, shouldFilterItem: FilterSearchViewsExampleData_1.shouldFilterItem, filters: FilterSearchViewsExampleData_1.filters, views: [
                    {
                        key: 'list',
                        text: 'List',
                        ariaLabel: 'List view',
    ...
    FilterSearchViewsGroupedDataExample.prototype._renderList = function (filteredItems, renderMethod) {
        return React.createElement(React.Fragment, null, filteredItems.map(function (item, index) { return FilterSearchViewsExampleList_1.renderItem(item, index, renderMethod); }));
    };
    return FilterSearchViewsGroupedDataExample;
}(React.Component));
exports.FilterSearchViewsGroupedDataExample = FilterSearchViewsGroupedDataExample;

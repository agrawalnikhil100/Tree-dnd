...
describe('FilterSearchBox', function () {
    it('onSearchTextChange is called when typing in text box', function () {
        ...
        var wrapper = enzyme_1.mount(React.createElement(_1.FilterSearchBox, { strings: strings, searchText: 'test', onSearchTextChange: onSearchTextChange }));
        // Find the search box
    ...
    it('active states update as appropriate', function () {
        var wrapper = enzyme_1.mount(React.createElement(_1.FilterSearchBox, { strings: strings, searchText: 'test', onSearchTextChange: jest.fn(), filters: filters, selectedFilterKey: filters[0].key, onFilterChange: jest.fn(), styles: {
                root: 'test-root',
        ...
        var searchBox = wrapper.find(SearchBox_1.SearchBox);
    ...
    it('applies styles to tooltiphost and button as appropriate', function () {
        var testStrings = tslib_1.__assign({}, strings);
        var wrapper = enzyme_1.mount(React.createElement(_1.FilterSearchBox, { strings: testStrings, searchText: 'test', onSearchTextChange: jest.fn(), filters: filters, selectedFilterKey: filters[0].key, onFilterChange: jest.fn(), styles: {
    ...
    it('testing defaultButton tooltip is not rendered when tooltipText does not exist', function () {
        ...
        var wrapper = enzyme_1.mount(React.createElement(_1.FilterSearchBox, { strings: stringObject, searchText: 'test', onSearchTextChange: jest.fn(), filters: filters, selectedFilterKey: filters[0].key, styles: {
                filterButtonRoot: 'test-filter-btn'
            } }));
        // Verify tooltip is not rendered
        var tooltip = wrapper.find(Tooltip_1.TooltipHost);
        expect(tooltip.length).toBe(0);
        var filterButton = wrapper.find(Button_1.DefaultButton);
    ...
    it('calls onFilterChange when a filter is clicked', function () {
        ...
        var wrapper = enzyme_1.mount(React.createElement(_1.FilterSearchBox, { strings: strings, searchText: 'test', onSearchTextChange: jest.fn(), filters: filters, selectedFilterKey: filters[0].key, onFilterChange: onFilterChange }));
        var filterButton = wrapper.find(Button_1.DefaultButton);
    ...
    it('sets checked appropriately', function () {
        var wrapper = enzyme_1.mount(React.createElement(_1.FilterSearchBox, { strings: strings, searchText: 'test', onSearchTextChange: jest.fn(), filters: filters, selectedFilterKey: filters[0].key, onFilterChange: jest.fn() }));
        var filterButton = wrapper.find(Button_1.DefaultButton);
        expect(filterButton.length).toEqual(1);
        ...
        filterButton = wrapper.find(Button_1.DefaultButton);
    ...
    it('consumes strings correctly', function () {
        var wrapper = enzyme_1.mount(React.createElement(_1.FilterSearchBox, { strings: {
    ...
    it('focuses search box when focus is called on componentRef', function () {
        ...
        var wrapper = enzyme_1.mount(React.createElement(_1.FilterSearchBox, { strings: strings, searchText: 'test', onSearchTextChange: jest.fn(), filters: filters, selectedFilterKey: filters[0].key, onFilterChange: jest.fn(), componentRef: ref }));
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    it('does not render filter selection when less than two filters are provided', function () {
        var wrapper = enzyme_1.mount(React.createElement(_1.FilterSearchBox, { strings: strings, searchText: 'test', onSearchTextChange: jest.fn() }));
        var filterButton = wrapper.find(Button_1.DefaultButton);
    ...
    it('Should pass searchText onto the Fabric SearchBox component', function () {
        var wrapper = enzyme_1.mount(React.createElement(_1.FilterSearchBox, { strings: strings, searchText: 'test', onSearchTextChange: jest.fn() }));
        expect(wrapper.find(SearchBox_1.SearchBox).props().value).toEqual('test');
        wrapper.setProps({ searchText: 'new' });
        expect(wrapper.find(SearchBox_1.SearchBox).props().value).toEqual('new');
    });
});

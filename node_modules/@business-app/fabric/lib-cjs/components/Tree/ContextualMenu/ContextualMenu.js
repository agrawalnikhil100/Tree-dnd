...
var ContextualMenu = /** @class */ (function (_super) {
    ...
    ContextualMenu._removeConsecutiveSeparators = function (items) {
        ...
        for (var menuItemIndex = items.length - 1; menuItemIndex >= 0; menuItemIndex--) {
            var currentIsSeparator = items[menuItemIndex].itemType === ContextualMenu_1.ContextualMenuItemType.Divider || items[menuItemIndex].name === '-';
    ...
    ContextualMenu.prototype.render = function () {
        ...
        return (React.createElement(ContextualMenu_1.ContextualMenu, tslib_1.__assign({ gapSpace: gapSpace, directionalHint: directionalHint }, this.props, { items: displayItems, ariaLabel: ariaLabel, className: className, onDismiss: this._onDismiss })));
    };
    ContextualMenu.prototype.componentDidMount = function () {
        ...
        this._events.on(document, 'keydown', function (event) {
            ...
            if (event.which !== Utilities_1.KeyCodes.shift &&
                event.which !== Utilities_1.KeyCodes.ctrl &&
                event.which !== Utilities_1.KeyCodes.alt &&
    ...
    ContextualMenu.prototype.contains = function (element) {
        return Utilities_1.elementContains(ReactDOM.findDOMNode(this), element);
    };
    ...
    ContextualMenu.prototype._setTimeout = function (callback, milliseconds) {
        ...
        var timerId = window.setTimeout.apply(window, tslib_1.__spreadArrays([callback, milliseconds], args));
        if (!this._timers) {
            this._timers = [];
        }

...
exports.useAsyncArrayTree = void 0;
var tslib_1 = require("tslib");
var React = require("react");
var useArrayTree_1 = require("./useArrayTree");
function useAsyncArrayTree(topLevelItems, onLoadChildren, loadingSubItemFactory, loadMoreSubItemFactory, errorSubItemFactory) {
    var _this = this;
    if (topLevelItems === void 0) { topLevelItems = []; }
    var _a = useArrayTree_1.useArrayTree(topLevelItems), appendChildrenTo = _a.appendChildrenTo, remove = _a.remove, replace = _a.replace, refresh = _a.refresh, rest = tslib_1.__rest(_a, ["appendChildrenTo", "remove", "replace", "refresh"]);
    ...
    var load = React.useCallback(function (item, continuationToken) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    loadMoreSubItem_1 = newContinuationToken_1 !== null && loadMoreSubItemFactory !== undefined
                        ...
                        : null;
                    appendChildrenTo(item, tslib_1.__spreadArrays(augmentChildren(item, children), (loadMoreSubItem_1 !== null ? [loadMoreSubItem_1] : [])));
                    return [3 /*break*/, 4];
                case 3:
                    e_1 = _b.sent();
                    if (item !== null) {
    ...
    var loadMore = React.useCallback(function (item, continuationToken) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
    ...
    return tslib_1.__assign({ load: load,
        loadMore: loadMore,
        remove: remove,
        replace: replace,
...
exports.useAsyncArrayTree = useAsyncArrayTree;

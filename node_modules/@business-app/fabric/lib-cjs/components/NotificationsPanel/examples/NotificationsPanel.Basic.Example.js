...
exports.NotificationsPanelBasicExample = void 0;
...
var NotificationsPanelBasicExample = /** @class */ (function (_super) {
    tslib_1.__extends(NotificationsPanelBasicExample, _super);
    function NotificationsPanelBasicExample(props) {
        ...
        _this._handleShowPanelClick = function () {
            _this.state.notifications.length === 0
                ? _this.setState({ open: true, panelState: NotificationsPanel_types_1.NotificationsPanelState.Empty })
                : _this.setState({ open: true, panelState: NotificationsPanel_types_1.NotificationsPanelState.Loaded });
        };
        _this._handleShowPanelWithLoadingStateClick = function () {
            _this.setState({ open: true, panelState: NotificationsPanel_types_1.NotificationsPanelState.Loading });
        };
        _this._handleShowPanelWithErrorClick = function () {
            _this.setState({ open: true, panelState: NotificationsPanel_types_1.NotificationsPanelState.Error });
        };
        ...
        _this._onDismissAllNotifications = function () {
            _this.setState({ notifications: [], panelState: NotificationsPanel_types_1.NotificationsPanelState.Empty });
        };
        ...
        _this._renderSettingsIcon = function () {
            ...
            return (React.createElement("div", { style: { paddingLeft: 15, paddingBottom: 10 } },
                React.createElement(Button_1.ActionButton, { iconProps: settingsIcon, onClick: _this._onClickSettings }, "Settings")));
        };
        _this._renderSettingsPanelFooter = function () {
            return (React.createElement("div", { style: { padding: 20, paddingLeft: 140 } },
                React.createElement(Button_1.DefaultButton, { text: "Cancel", onClick: _this._onSettingPanelDismiss, allowDisabledFocus: true }),
                React.createElement("span", { style: { padding: 5 } }),
                React.createElement(Button_1.PrimaryButton, { text: "Save", onClick: _this._onSettingPanelDismiss, allowDisabledFocus: true })));
        };
        _this._exampleNotifications = [
            {
                ...
                onRenderIcon: function () { return React.createElement(Icon_1.Icon, { iconName: "AccessLogo" }); },
        ...
        _this.state = {
            ...
            panelState: NotificationsPanel_types_1.NotificationsPanelState.Loaded,
            openSettings: false
        };
        return _this;
    }
    NotificationsPanelBasicExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement(Toggle_1.Toggle, { label: "Has notifications", checked: !empty, onChanged: this._handleHasNotificationsToggleChange }),
            React.createElement(Button_1.DefaultButton, { onClick: this._reloadNotifications },
                " ",
                'Reload Notifications',
                " "),
            React.createElement("br", null),
            React.createElement(Button_1.DefaultButton, { onClick: this._handleShowPanelClick },
                " ",
                'Show Notifications Panel',
                " "),
            React.createElement("br", null),
            React.createElement(Button_1.DefaultButton, { onClick: this._handleShowPanelWithErrorClick },
                ' ',
                'Show Panel With Error',
                ' '),
            React.createElement("br", null),
            React.createElement(Button_1.DefaultButton, { onClick: this._handleShowPanelWithLoadingStateClick },
                ' ',
                'Show panel with loading state',
                ' '),
            React.createElement("div", { className: "ba-NotificationsPanel-BasicExample" },
                React.createElement(__1.NotificationsPanel, { ariaLoadingMessage: "The notifications panel is loading.", panelState: this.state.panelState, errorPrimaryMessage: "Something went wrong. Please try again later", errorSecondaryMessage: "failed to get notifications", emptyStateMessage: "No Notifications", dismissAllText: "Dismiss All", onDismissAll: this._onDismissAllNotifications, isOpen: open, onDismiss: this._onDismiss, headerText: "Notifications", notifications: !empty && this.state.notifications, onRenderFooter: this._renderSettingsIcon, closeButtonAriaLabel: 'Close' })),
            React.createElement("div", { className: "ba-SettingsPanel-BasicExample" },
                React.createElement(Panel_1.Panel, { headerText: "Settings", isOpen: openSettings, closeButtonAriaLabel: "Close", onDismiss: this._onSettingPanelDismiss, onRenderFooter: this._renderSettingsPanelFooter, isFooterAtBottom: true },
                    React.createElement("div", null, "Please customize your settings here. A Sample is provided below"),
                    React.createElement("br", null),
                    React.createElement(Toggle_1.Toggle, { label: "Enable toast notifications", defaultChecked: true, onText: "On", offText: "Off" }),
                    React.createElement(Toggle_1.Toggle, { label: "Enabled sound alerts", defaultChecked: true, onText: "On", offText: "Off" }),
                    React.createElement(TextField_1.TextField, { label: "Total duration (seconds)", styles: narrowTextFieldStyles })))));
    };
    return NotificationsPanelBasicExample;
}(React.Component));
exports.NotificationsPanelBasicExample = NotificationsPanelBasicExample;

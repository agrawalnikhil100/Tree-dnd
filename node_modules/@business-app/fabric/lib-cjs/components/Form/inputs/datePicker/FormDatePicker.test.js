...
var FormDatePicker_base_1 = require("./FormDatePicker.base");
var FormDatePicker_styles_1 = require("./FormDatePicker.styles");
describe('FormDatePicker Unit Tests', function () {
    var wrapper;
    var styleProps = {
        theme: Styling_1.getTheme(),
        styles: FormDatePicker_styles_1.getStyles
    };
    describe('Renders for all combinations of props', function () {
        it('Null name throws error', function () {
            ...
            var errorFunction = function () {
                ReactTestUtils.renderIntoDocument(React.createElement(Form_1.Form, { onSubmit: undefined },
                    React.createElement(FormDatePicker_base_1.FormDatePickerBase, tslib_1.__assign({}, styleProps, { inputKey: null, value: undefined }))));
            };
        ...
        it('Null props still render', function () {
            wrapper = Enzyme.mount(React.createElement(Form_1.Form, { onSubmit: undefined },
                React.createElement(FormDatePicker_base_1.FormDatePickerBase, tslib_1.__assign({}, styleProps, { inputKey: "name", value: undefined, validators: undefined }))));
        ...
        it('With initial value', function () {
            ...
            wrapper = Enzyme.mount(React.createElement(Form_1.Form, { onSubmit: function (value) {
                ...
                React.createElement(FormDatePicker_base_1.FormDatePickerBase, tslib_1.__assign({}, styleProps, { inputKey: "name", value: now }))));
            expect(wrapper.find('ms-DatePicker')).toBeTruthy();
    ...
    describe('DatePicker update tests', function () {
        ...
        var ExtendsDatePicker = /** @class */ (function (_super) {
            tslib_1.__extends(ExtendsDatePicker, _super);
        ...
        }(FormDatePicker_base_1.FormDatePickerBase));
        ...
        it.skip('DatePicker is leading and trailing debounced', function (done) {
            ...
            ReactTestUtils.renderIntoDocument(React.createElement(Form_1.Form, { ref: formRef, onUpdated: updateStub },
                React.createElement(ExtendsDatePicker, tslib_1.__assign({}, styleProps, { inputKey: "name", value: new Date() }))));

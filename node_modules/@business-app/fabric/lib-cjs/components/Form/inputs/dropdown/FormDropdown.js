...
var FormDropdown = /** @class */ (function (_super) {
    tslib_1.__extends(FormDropdown, _super);
    function FormDropdown(props, context) {
        ...
        _this._onChange = function (event, option) {
            ...
            if (dropdownProps && dropdownProps.multiSelect) {
                ...
                var optionIndex = Utilities_1.findIndex(value, function (v) { return v === option.key; });
                if (selected) {
    ...
    FormDropdown.prototype.render = function () {
        ...
        return (React.createElement(Dropdown_1.Dropdown, tslib_1.__assign({ options: [], calloutProps: {

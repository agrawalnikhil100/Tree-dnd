...
exports.NaturalNumberField = exports.IntegerField = exports.NumericalField = void 0;
...
var NumericalField = /** @class */ (function (_super) {
    tslib_1.__extends(NumericalField, _super);
    ...
    NumericalField.prototype.render = function () {
        ...
        return (React.createElement(TextField_1.TextField, tslib_1.__assign({}, textFieldProps, { className: Utilities_1.css('ba-NumericalField', textFieldProps && textFieldProps.className), value: formatValue === false ? stringValue : formattedValue, onChange: this.applyInput, onBlur: this.onBlur })));
    };
...
var NaturalNumberField = /** @class */ (function (_super) {
    tslib_1.__extends(NaturalNumberField, _super);
...
exports.NaturalNumberField = NaturalNumberField;

...
describe('Wizard Footer', function () {
    ...
    it('supports hiding the back button', function () {
        var noop = jest.fn();
        var wrapper = Enzyme.shallow(React.createElement(WizardFooter_base_1.WizardFooterBase, { backButtonText: "Back", backButtonProps: { className: 'back' }, continueButtonText: "Next", continueButtonProps: { className: 'next' }, canGoToNextStep: true, canGoToPreviousStep: false, shouldDisplayBackButton: false, goToNextStep: noop, goToPreviousStep: noop }));
    ...
    it('supports hiding the next button', function () {
        var noop = jest.fn();
        var wrapper = Enzyme.shallow(React.createElement(WizardFooter_base_1.WizardFooterBase, { backButtonText: "Back", backButtonProps: { className: 'back' }, continueButtonText: "Next", canGoToNextStep: true, canGoToPreviousStep: false, shouldDisplayBackButton: true, shouldHideContinueButton: true, goToNextStep: noop, goToPreviousStep: noop }));

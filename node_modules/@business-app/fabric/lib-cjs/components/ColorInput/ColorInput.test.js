...
describe('Color input', function () {
    ...
    it('should render the component', function () {
        var wrapper = Enzyme.mount(React.createElement(_1.ColorInput, { label: label, colorPickerProps: colorPickerProps }));
    ...
    it('should render the icon if tooltipIconProps provided', function () {
        var wrapper = Enzyme.mount(React.createElement(_1.ColorInput, { label: label, colorPickerProps: colorPickerProps, tooltipIconProps: tooltipIconProps }));
    ...
    it('should invoke the onBlur of color input text field', function () {
        ...
        var wrapper = Enzyme.mount(React.createElement(_1.ColorInput, { label: label, colorPickerProps: colorPickerProps, colorTextFieldProps: {
                onBlur: mockedOnBlur
            } }));
    ...
    it('should open the color picker when ShowColorPicker prop set to true', function () {
        var wrapper = Enzyme.mount(React.createElement(_1.ColorInput, { label: label, colorPickerProps: colorPickerProps, showColorPicker: true }));
    ...
    it('should not open the color picker when ShowColorPicker prop set to false', function () {
        var wrapper = Enzyme.mount(React.createElement(_1.ColorInput, { label: label, colorPickerProps: colorPickerProps, showColorPicker: false }));

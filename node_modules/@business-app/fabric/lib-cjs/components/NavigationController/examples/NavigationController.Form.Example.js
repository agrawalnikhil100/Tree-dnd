...
exports.NavigationControllerFormExample = void 0;
...
var NavigationControllerFormExample = /** @class */ (function (_super) {
    tslib_1.__extends(NavigationControllerFormExample, _super);
    function NavigationControllerFormExample(props) {
        ...
        _this.renderEmojiCell = function (value, isSelected, onSelect) {
            ...
            return (React.createElement("div", { onClick: function () { return onSelect(value); }, className: Styling_1.mergeStyles(emojiCellStyle) }, value));
        };
    ...
    NavigationControllerFormExample.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { className: Styling_1.mergeStyles(containerStyles) },
                React.createElement(__1.NavigationController, { initialActiveViewKey: stepsKeys.basic, componentRef: this.NavigationControllerRef, showBackButton: true, backButtonAriaLabel: 'Back' }, function (context) { return [
                    React.createElement(NavigationControllerView_1.NavigationControllerView, { viewKey: stepsKeys.basic, key: stepsKeys.basic, headerText: "Basic Details", footerButtons: [
                            {
                                primary: true,
                        ...
                        React.createElement(TextField_1.TextField, { key: "name", value: _this.state.name, onChange: function (event, value) { return _this.setState({ name: value }); }, onGetErrorMessage: _this.getNameErrorMessage, label: "Name" }),
                        React.createElement(TextField_1.TextField, { key: "age", value: _this.state.age ? _this.state.age.toString() : '', onChange: function (event, value) { return _this.setState({ age: Number(value) }); }, onGetErrorMessage: function (value) { return _this.getAgeErrorMessage(value === '' ? NaN : Number(value)); }, label: "Age" })),
                    React.createElement(NavigationControllerView_1.NavigationControllerView, { key: stepsKeys.moreInfo, viewKey: stepsKeys.moreInfo, headerText: "Favorite Emoji", footerButtons: [
                            {
                                primary: true,
                    ...
                    React.createElement(NavigationControllerView_1.NavigationControllerView, { key: stepsKeys.summary, viewKey: stepsKeys.summary, headerText: "Submit", footerButtons: [
                            {
                                primary: true,
                        ...
                        React.createElement(Label_1.Label, null, "Review your selections here:"),
...
exports.NavigationControllerFormExample = NavigationControllerFormExample;

...
import { IComponentAs, IRefObject, IRenderFunction, IStyleFunctionOrObject } from '@fluentui/react/lib/Utilities';
...
export interface IAccordionStyleProps extends Pick<IAccordionState, 'isContentVisible'>, Pick<IAccordionProps, 'theme'> {

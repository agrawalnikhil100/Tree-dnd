...
exports.TreeViewCustomItemExample = void 0;
...
var TreeViewCustomItemExample = /** @class */ (function (_super) {
    tslib_1.__extends(TreeViewCustomItemExample, _super);
...
exports.TreeViewCustomItemExample = TreeViewCustomItemExample;
var customStyles = Styling_1.mergeStyleSets({
    itemContainer: {
        flex: '1 1 auto',
        display: 'flex',
        flexDirection: 'row',

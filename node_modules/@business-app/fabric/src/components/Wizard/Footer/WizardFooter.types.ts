...
export type IButtonPropsWithAutomationId = IButtonProps & {
...
export interface WizardFooterProps extends IPropsWithStyles<WizardFooterStyleProps, WizardFooterStyles> {
  ...
  goToNextStep(): void;
  renderFooterContent?(
    defaultFooterButtonsRender: () => React.ReactNode,
    defaultFooterSummaryRender: () => React.ReactNode
  ): React.ReactNode;
}

export type WizardFooterStyleProps = {
  theme: ITheme;
  className?: string;
};

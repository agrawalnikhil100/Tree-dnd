 ...
 */
export abstract class FormBaseInput<T, P extends IFormBaseInputProps<T>, S extends IFormBaseInputState<T>>
  extends BaseComponent<P, S>
  implements IFormBaseInput<T> {
   ...
   */
  protected readonly debouncedSubmitValue: ICancelable<IFormContext['submitValue']> &
    ((input: GenericFormInput) => void);
  ...
  public static getDerivedStateFromProps(
    nextProps: IFormBaseInputProps<unknown>,
    prevState: IFormBaseInputState<unknown>
  ) {
    FormBaseInput._validateProps(nextProps);

    const value = prevState.prevPropValue;
  ...
  public setError(errorMessage?: string): void {
    this.setState((prevState: S) => {
      ...
      prevState.prevPropValue = this.props.value;
      return prevState;
    });
  }
   ...
   */
  private static _validateProps(props: IFormBaseInputProps<unknown>): void {
    if (!props.inputKey) {

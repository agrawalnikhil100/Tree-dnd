...
export type ITwoTierSettingsExplorerStyles = ISettingsExplorerStyles;

export type ICommitButtonProps = IButtonProps;
export type IExitButtonProps = Pick<IButtonProps, 'onClick' | 'ariaLabel'>;

export type ISettingsExplorerStyleProps = Pick<ISettingsExplorerProps, 'theme'>;
...
export type SettingsPageInfo = ISettingsPageProps & { page: any };

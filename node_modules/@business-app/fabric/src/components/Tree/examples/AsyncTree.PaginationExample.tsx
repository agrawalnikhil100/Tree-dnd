...
export const AsyncTreePaginationExample: React.FC = () => {
  const throwErrorsRef = React.useRef(false);

  const onResolveItems: IAsyncTreeProps['onResolveItems'] = React.useCallback(
    async (item, continuationToken) => {
      await wait(1500);
      ...
      return [items, endIndex.toString()];
    },
    []
  );

...
export interface ITreeProps<T extends ITreeItem> {
   ...
   */
  scrollView?: React.ComponentType<{ children?: React.ReactNode; className?: string }>;
...
export type ITreeStyleProps = Required<Pick<ITreeProps<ITreeItem>, 'theme' | 'nodeHeight' | 'iconWidth'>> &
  Pick<ITreeProps<ITreeItem>, 'className'>;

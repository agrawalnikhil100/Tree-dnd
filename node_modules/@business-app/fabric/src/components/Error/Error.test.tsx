...
describe('Error', () => {
  ...
  it('should not unexpectedly change', () => {
    const seeDetailsShowLabel = 'See details';
    const seeDetailsHideLabel = 'Hide details';
    ...
    wrapper = Enzyme.mount(
      <ErrorBase
        ...
        title={'Title'}
        subtitle={'Subtitle'}
        seeDetailsLinkShowLabel={seeDetailsShowLabel}
        seeDetailsLinkHideLabel={seeDetailsHideLabel}
        errorDetails={{
  ...
  it('should expand See Details section', () => {
    const seeDetailsShowLabel = 'See details';
    const seeDetailsHideLabel = 'Hide details';
    wrapper = Enzyme.mount(
      <ErrorBase
    ...
    expect(wrapper.find('.ba-Error-SeeDetailsButton').first().getElement().props.text).toEqual(
      seeDetailsShowLabel
    );
  ...
  it('should render Learn More link when subtitle not provided', () => {
    wrapper = Enzyme.mount(
      <ErrorBase
        title={'Title'}
        {...props}
  ...
  it('should render all provided controls optionally', () => {
    const seeDetailsShowLabel = 'See details';
    const seeDetailsHideLabel = 'Hide details';

 ...
 */
export interface IPanelStepProps
  extends Omit<IPanelProps, keyof InheritedPanelProps | 'ref' | 'footerButtons'> {
 ...
 */
export type InheritedPanelProps = Pick<
  IPanelProps,
  | 'isOpen'
  | 'isBlocking'
  | 'isHiddenOnDismiss'
...
export interface IMultistepPanelFooterButtonProps
  extends Omit<IPanelFooterButtonProps, 'dismissableOnClick'> {
  /**

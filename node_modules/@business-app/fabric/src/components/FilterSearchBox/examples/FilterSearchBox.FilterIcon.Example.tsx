...
import { FilterSearchBox, IFilterItem } from '../index';

export interface IFilterSearchBoxFilterIconExampleState {
  searchText: string;
...
export class FilterSearchBoxFilterIconExample extends React.Component<
  {},
  IFilterSearchBoxFilterIconExampleState
> {

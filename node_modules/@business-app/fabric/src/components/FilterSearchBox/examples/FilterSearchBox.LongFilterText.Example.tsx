...
export interface IFilterSearchBoxLongFilterTextExampleState {
  searchText: string;
...
const filters: IFilterItem[] = [
  {
    key: 'one',
    text:
      'Filter 1Filter 1Filter 1Filter 1Filterter 1Filter 1Filter 1Filter 1Filter 1Filter 1Filter 1Filter 1Filter 1Filter 1Filter 1Filter 1Filter 1Filter 1Filter 1Filter 1Filter 1Filter 1Filter 1Filter 1Filter 1'
  },
  { key: 'two', text: 'Filter 2' },
  { key: 'three', text: 'Filter 3' }
];

export class FilterSearchBoxLongFilterTextExample extends React.Component<
  {},
  IFilterSearchBoxLongFilterTextExampleState
> {

...
export var PowerAppsGrayscaleDarkPalette = {
    white: '#1b1a19',
    neutralLighterAlt: '#292828',
    neutralLighter: 'rgba(255, 255, 255, 0.05)',
    neutralLight: '#2d2c2c',
    neutralQuaternaryAlt: '#3b3a3a',
    neutralQuaternary: '#3b3a3a',
    neutralPrimaryAlt: '#f3f2f1',
    neutralDark: '#c8c6c4',
    neutralPrimary: '#f3f2f1',
    black: '#fff' // Black
};
export var PowerAppsGrayscaleContrastPalette = {
    white: '#000',
...
export var PowerAutomateGrayscalePalette = {
    black: '#000',
    neutralDark: '#201f1e',
    neutralPrimary: '#323130',
...
export var PowerVirtualAgentGrayscalePalette = {
    black: '#000',
    neutralDark: '#201f1e',
    neutralPrimary: '#323130',
    neutralPrimaryAlt: '#3b3a39',
...
export var PowerVirtualAgentGrayscaleDarkPalette = {
    black: '#fff',
    neutralDark: '#faf9f8',
    neutralPrimary: '#f3f2f1',
...
export var PowerVirtualAgentGrayscaleContrastPalette = {
    black: '#ffffff',
    neutralDark: '#ffffff',
...
export var DesignDocsTheme = {
    ...
    semanticColors: {
        ...
        blockingBackground: '#fed9cc',
        warningBackground: '#fff4ce',
        successBackground: '#dff6dd',
        link: '#a65fdd',
        linkHovered: '#763aa5',
        messageLink: '#a65fdd',
        messageLinkHovered: '#763aa5'
    }
};
export var PowerAppsTheme = {
    ...
    semanticColors: {
        ...
        linkHovered: '#501b50',
        messageLink: '#8d308d',
        messageLinkHovered: '#501b50'
    }
};
export var PowerAppsDarkTheme = {
    palette: __assign({ themePrimary: '#742774', themeSecondary: '#8d308d' }, PowerAppsGrayscaleDarkPalette)
};
export var PowerAppsContrastTheme = {
    palette: __assign({ themePrimary: '#742774', themeSecondary: '#8d308d' }, PowerAppsGrayscaleContrastPalette)
};
...
export var PowerAutomateTheme = {
    ...
    semanticColors: {
        ...
        linkHovered: '#0047b3',
        messageLink: '#1975ff',
        messageLinkHovered: '#0047b3'
    }
};
export var PowerVirtualAgentTheme = (function () {
    var palette = __assign({ themeDarker: '#062d37', themeDark: '#073845', themeDarkAlt: '#0a4a5c', themePrimary: '#0b556a', themeSecondary: '#0f677b', themeTertiary: '#14848f', themeLight: '#73e3df', themeLighter: '#cff6f9', themeLighterAlt: '#f1fbfe', purple: '#672367', blue: '#118DFF', green: '#6BB700', magenta: '#D98FD9', teal: '#73E3DF', purpleLight: '#F0E9F0', blueLight: '#E7F4FF', greenLight: '#F0F8E6' }, PowerVirtualAgentGrayscalePalette);
    return {
        palette: palette,
        semanticColors: {
            link: '#10738e',
            linkHovered: palette.themeDark,
            messageLink: '#10738e',
            messageLinkHovered: palette.themeDark,
            primaryButtonBackground: palette.themePrimary,
            primaryButtonText: palette.white,
            primaryButtonBorder: palette.white,
            primaryButtonBackgroundHovered: palette.themeDarkAlt,
            primaryButtonTextHovered: palette.white,
            primaryButtonBackgroundPressed: '#edebe9',
            primaryButtonTextPressed: palette.white,
            focusBorder: palette.black
        }
    };
})();
export var PowerVirtualAgentDarkTheme = (function () {
    var palette = __assign({ themeDarker: '#69ebed', themeDark: '#64e0e2', themeDarkAlt: '#34d6d8', themePrimary: '#00c9cc', themeSecondary: '#00b1b4', themeTertiary: '#00787a', themeLight: '#003c3d', themeLighter: '#002021', themeLighterAlt: '#000808', purple: '#D25FD2', blue: '#2899F5', green: '#92C353', magenta: '#7C2E7C', teal: '#00787A', purpleLight: '#3D2A3B', blueLight: '#293F50', greenLight: '#3E4730' }, PowerVirtualAgentGrayscaleDarkPalette);
    return {
        palette: palette,
        semanticColors: {
            link: palette.themePrimary,
            linkHovered: palette.themeDark,
            bodyBackgroundChecked: palette.neutralQuaternaryAlt,
            bodyBackground: palette.white,
            bodyBackgroundHovered: palette.neutralLight,
            bodyTextChecked: palette.neutralPrimary,
            ...
            primaryButtonTextPressed: palette.white,
            primaryButtonBackgroundDisabled: palette.neutralLighterAlt,
            primaryButtonTextDisabled: palette.neutralTertiary,
            focusBorder: palette.black,
            inputBackground: palette.white,
            inputText: palette.neutralPrimary,
            inputPlaceholderText: palette.black,
            inputFocusBorderAlt: palette.themePrimary,
            warningIcon: palette.neutralPrimaryAlt,
            ...
            successIcon: palette.green,
            successBackground: '#393D1B'
        }
    };
})();
export var PowerVirtualAgentContrastTheme = (function () {
    var palette = __assign({ themeDarker: '#000000', themeDark: '#000000', themeDarkAlt: '#000000', themePrimary: '#000000', themeSecondary: '#000000', themeTertiary: '#000000', themeLight: '#000000', themeLighter: '#000000', themeLighterAlt: '#000000', purple: '#000000', blue: '#000000', green: '#000000', magenta: '#000000', teal: '#000000', purpleLight: '#000000', blueLight: '#000000', greenLight: '#000000' }, PowerVirtualAgentGrayscaleContrastPalette);
    var yellow = '#fffd39';
    var green = '#2ef149';
    var cyan = '#00ebfd';
    return {
        ...
        semanticColors: {
            link: yellow,
            linkHovered: yellow,
            bodyBackgroundChecked: cyan,
            bodyBackground: palette.white,
            bodyBackgroundHovered: cyan,
            bodyTextChecked: palette.white,
            bodyText: palette.black,
            primaryButtonBackground: palette.black,
            primaryButtonText: palette.white,
            primaryButtonBorder: palette.black,
            primaryButtonBackgroundHovered: cyan,
            primaryButtonTextHovered: palette.white,
            primaryButtonBackgroundPressed: cyan,
            primaryButtonTextPressed: palette.white,
            primaryButtonBackgroundDisabled: green,
            primaryButtonTextDisabled: green,
            focusBorder: palette.black,
            inputBackground: palette.white,
            inputText: palette.black,
            inputPlaceholderText: palette.black,
            inputFocusBorderAlt: palette.black,
            disabledText: green,
            errorText: palette.black,
            errorIcon: palette.black,
            successIcon: palette.black,
            severeWarningIcon: palette.black,
            successBackground: palette.white,
            severeWarningBackground: palette.white,
            warningBackground: palette.white,
...
export var Dynamics365Theme = {
    ...
    semanticColors: {
        ...
        linkHovered: '#0742ab',
        messageLink: '#1f6cf9',
        messageLinkHovered: '#0742ab'
    }
};
export var FlowTheme = {
    palette: __assign(__assign({ themePrimary: '#0066ff', themeSecondary: '#1975ff', themeLighterAlt: '#f2f7ff', themeLighter: '#e6f0ff', themeLight: '#cce0ff', themeTertiary: '#94bfff', themeDarkAlt: '#005ce6' }, PowerAutomateGrayscalePalette), { themeDark: '#0047b3', themeDarker: '#00388c' })
};
// export new palettes with old export to avoid breaking partner teams who have used these values

...
import { ResizeDirection, ResizerAttachment, ResizerLocation } from './Resizer.types';
var getClassNames = classNamesFunction();
var DEFAULT_HANDLE_SIZE = 5;
var DEFAULT_KEYBOARD_MOVE = 5;
var ResizerBase = /** @class */ (function (_super) {
    __extends(ResizerBase, _super);
    function ResizerBase(props) {
        ...
        _this.getCursorPosition = function (ev) {
            return _this.state.resizeDirection === ResizeDirection.Horizontal ? ev.pageX : ev.pageY;
        };
        _this.getResizerPositionStyles = function () {
            var _a = _this.props, location = _a.location, _b = _a.handleSize, handleSize = _b === void 0 ? DEFAULT_HANDLE_SIZE : _b, _c = _a.attachment, attachment = _c === void 0 ? ResizerAttachment.Outside : _c;
            var handlePosition = _this.state.resizeRelativeValue - (attachment === ResizerAttachment.Inside ? 0 : handleSize);
            switch (location) {
    ...
    ResizerBase.getResizerInfo = function (props, prevState) {
        ...
        var resizeDirection = location === ResizerLocation.Left || location === ResizerLocation.Right
            ? ResizeDirection.Horizontal
            : ResizeDirection.Vertical;
        var isResizeHorizontal = resizeDirection === ResizeDirection.Horizontal;
    ...
    ResizerBase.prototype.render = function () {
        ...
        var resizerStyles = __assign({ cursor: cursor }, this.getResizerPositionStyles());
        return (React.createElement("div", { "aria-label": ariaLabel, "aria-orientation": resizeDirection === ResizeDirection.Horizontal ? 'vertical' : 'horizontal', role: 'separator', tabIndex: 0, className: classNames.root, style: resizerStyles, onKeyDown: this.handleArrowKeys, onMouseDown: this.handleMouseDown }));
    };

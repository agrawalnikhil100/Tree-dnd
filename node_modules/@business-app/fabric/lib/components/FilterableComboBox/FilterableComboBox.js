...
export function filterableComboBox(ComboBoxComponent) {
    return /** @class */ (function (_super) {
        __extends(FilterableComboBoxBase, _super);
        ...
        FilterableComboBoxBase.prototype.render = function () {
            var _a = this.props, _b = _a.onFilterOptions, onFilterOptions = _b === void 0 ? filterOptions : _b, options = _a.options, noResultsMessage = _a.noResultsMessage, rawProps = __rest(_a, ["onFilterOptions", "options", "noResultsMessage"]);
            ...
            return (React.createElement(React.Fragment, null,
                React.createElement(ComboBoxComponent, __assign({}, rawProps, { allowFreeform: true, autoComplete: "off", autofill: __assign(__assign({}, rawProps.autofill), { onFocus: this.onAutofillFocus, onBlur: this.onAutofillBlur }), componentRef: this.comboBoxRef, options: filteredOptions, text: this.props.allowFreeform
...
export var FilterableComboBox = filterableComboBox(ComboBox);

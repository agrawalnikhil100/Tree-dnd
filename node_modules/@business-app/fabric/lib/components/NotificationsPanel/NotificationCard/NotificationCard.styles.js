...
var clickActionStyle = {
    cursor: 'pointer'
};
export var getStyles = function (_a) {
    var hasOnClick = _a.hasOnClick, theme = _a.theme;
    var bodyClickActionStyle = hasOnClick
        ? ['ba-notificationCard-body--hasClickAction', clickActionStyle]
        : [];
    var textClickActionStyle = hasOnClick
    ...
    return {
        ...
        messageDescription: __spreadArrays([

...
import { getSidebarColors } from './Sidebar.styles';
...
export var styles = function (props) {
    var currentSidebarColors = getSidebarColors(props.theme);
    var buttonStyles = getSidebarButtonStyles(props.theme);
    var accordionStyles = {
        root: {
...
//# sourceMappingURL=SidebarAccordion.styles.js.map
...
var SidebarCollapsedExample = /** @class */ (function (_super) {
    __extends(SidebarCollapsedExample, _super);
    ...
    SidebarCollapsedExample.prototype.render = function () {
        ...
        return (React.createElement("div", { style: { height: 400 } },
            React.createElement(Sidebar, { id: 'sidebar-collapsed', collapsible: true, defaultIsCollapsed: false, theme: getTheme(), collapseButtonAriaLabel: 'sitemap', footerItems: [
                    {
...
export { SidebarCollapsedExample };

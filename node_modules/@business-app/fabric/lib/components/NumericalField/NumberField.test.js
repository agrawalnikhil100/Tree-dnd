...
describe('NumberField', function () {
    var AdaptedNumberField = function (props) { return (React.createElement(NumberField, { value: props.value, onBlurred: props.onChanged })); };
    ...
    it('should revert back to the previous value if non-numerical input is given', function () {
        ...
        expect(simulateInput(AdaptedNumberField, 321, '1', '12', '123', '123g', 'h123g', 'h123', 'h125', 'h25', '25', '2f5')).toEqual({
            hasBeenChanged: true,
            lastValue: 25
        });
    });
    ...
    describe('maxPrecision', function () {
        var PrecisionNumberField = function (maxPrecision) { return function (props) { return (React.createElement(NumberField, { value: props.value, onBlurred: props.onChanged, maxPrecision: maxPrecision })); }; };

...
export var TwoTierSettingsExplorerBase = function (props) {
    var _a, _b;
    ...
    return (React.createElement("div", { className: classnames.root, ref: ref },
        React.createElement(ExplorerPanel, { parentRef: ref, header: name, pageList: primaryPages, selectedKey: primaryPages[primarySelectedIndex].id, handleClick: setPrimarySelectedIndex, disableCollapsing: disablePanelCollapsing }),

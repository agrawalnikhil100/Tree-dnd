...
export var ShimmeredTreeBasicExample = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: exampleStyles.exampleContainer },
            React.createElement(ShimmeredTree, { items: treeItems, styles: treeStyles, strings: { moreCommandsAriaLabel: '', listAriaLabel: '' } }))));
};

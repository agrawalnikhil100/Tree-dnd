...
var TreeHeavilyCustomizedExample = /** @class */ (function (_super) {
    __extends(TreeHeavilyCustomizedExample, _super);
    function TreeHeavilyCustomizedExample(props) {
        ...
        _this._onItemSelected = function (item, type, isSelected, isExpanded, index) {
            ...
            if (type === SelectionType.Toggle) {
                selectedItemKeys = cloneSet(_this.state.selectedItemKeys);
    ...
    TreeHeavilyCustomizedExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: exampleStyles.exampleContainer },
            ...
            React.createElement(Toggle, { label: "Narrow width", checked: useShortWidth, onChange: this._onChangeWidthToggle, onText: "Narrow", offText: "Wide" }),
            React.createElement("div", { className: exampleStyles.controls },
                ...
                React.createElement(DefaultButton, { onClick: this._onClickClearSelection }, 'Clear selection')),
            React.createElement("div", { style: { width: useShortWidth ? '200px' : '280px', height: 320 } },
                React.createElement(Tree, { items: this.state.items, strings: {
                        listAriaLabel: 'test',
...
export { TreeHeavilyCustomizedExample };
...
var customizedStyles = mergeStyleSets({
    unselectableOddRow: {

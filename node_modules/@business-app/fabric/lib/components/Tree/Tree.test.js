...
function getDefaultProps(overrides) {
    return __assign({ items: getMockItems([{}, {}]), strings: {
...
function getMockItems(items, treeItems, level, parentIndex) {
    ...
    items.forEach(function (item, indexInParent) {
        var children = item.children, restItem = __rest(item, ["children"]);
        var itemId = level + " " + parentIndex + " " + indexInParent;
        // Add the item
        treeItems.push(__assign({ label: itemId, key: itemId, isFolder: !!children, level: level, setSize: items.length, indexInParent: indexInParent, testPropertyA: level * 100 + indexInParent, testPropertyB: itemId }, restItem));
...
describe('Tree', function () {
    describe('Collapse/Expand', function () {
        it('initialExpandedItemKeys', function () {
            ...
            var wrapper = mount(React.createElement(Tree, __assign({}, props)));
    ...
    describe('Selection', function () {
        ...
        it('Selection changes should result in node re-renders when necessary', function () {
            ...
            var wrapper = mount(React.createElement(Tree, __assign({}, props)));
            var isNodeSelected = function (index) { return wrapper.find(TreeNode).at(index).props().isSelected; };
    ...
    it('onRenderItemContainer should work', function () {
        ...
        var wrapper = mount(React.createElement(Tree, { items: [
                {
                    label: 'label',
                    key: 'key',
                    level: 0,
        ...
        var numberOfNodes = wrapper.find(TreeNode).length;
    ...
    it('Uncontrolled onItemExpand/onItemCollapse', function () {
        ...
        var collapseExpandSelector = "." + TreeAutomationSelectors.collapseExpandClassName;
        var items = getMockItems([
            {
                key: 'one',
                children: [
    ...
    it('itemIsSelected style should have higher precedence than itemIsSelectable', function () {
        ...
        var wrapper = mount(React.createElement(Tree, __assign({}, props, { styles: {
                itemIsSelectable: {
        ...
        var firstNode = wrapper.find(TreeNode).at(0).getDOMNode();

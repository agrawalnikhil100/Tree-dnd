...
var HighlightedTextBase = /** @class */ (function (_super) {
    __extends(HighlightedTextBase, _super);
    ...
    HighlightedTextBase.prototype.renderStrings = function (strings, labels) {
        var highlightedClassName = mergeStyles(this.classNames.highlights, getAccessibilityHighlightStyles(labels));
    ...
    HighlightedTextBase.prototype.toStrings = function (text, highlights) {
        ...
        var sortedHighlights = __spreadArrays(highlights).sort(function (a, b) {

    ...
    describe('toStrings', function () {
        ...
        beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                wrapper = mount(React.createElement(HighlightedText, { text: 'Hello world', highlights: [], labels: mockLabels }));
        ...
        it('highlights multi-byte and RTL', function () {
            ...
            var actual = toStrings(text, calculateWordHighlights(text, ['🤠']));
            var expected = [unhighlighted('Hello '), highlighted('🤠'), unhighlighted(' world')];
            expect(actual).toEqual(expected);
            var text2 = 'the name of this state in arabic is \u202Bمصر\u202C, yes?';
            var actual2 = toStrings(text2, calculateWordHighlights(text2, ['\u202Bمصر\u202C']));
            var expected2 = [

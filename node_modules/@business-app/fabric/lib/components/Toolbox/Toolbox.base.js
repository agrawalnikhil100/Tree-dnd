...
import { BaseComponent, classNamesFunction, customizable, divProperties, getId, getNativeProps, KeyCodes } from '@fluentui/react/lib/Utilities';
...
var ToolboxItemType = React.createElement(ToolboxItem).type;
var ToolboxBase = /** @class */ (function (_super) {
    __extends(ToolboxBase, _super);
    function ToolboxBase(props) {
        ...
        _this._renderToolboxLinks = function () {
            ...
            return (React.createElement(ToolboxLinksContainer, { componentRef: _this._focusZone, direction: FocusZoneDirection.vertical, className: _this._classNames.focusZone },
                React.createElement("ul", { className: _this._classNames.list, role: "tablist" },
                    React.createElement(CommandButton, { className: mergeStyles(ToolboxAutomationSelectors.expandCollapseLinksClassName, _this._classNames.item), onClick: _this._onCollapseButtonClick, onKeyPress: _this._onCollapseButtonKeyPress, "aria-expanded": linksAreExpanded, name: collapseButtonTitle, title: collapseButtonTitle, ariaLabel: collapseButtonTitle }, _this._renderLinkContent({ itemIcon: 'GlobalNavButton', itemKey: 'collapseButton' })),
                    items)));
        };
        _this._toolboxLinksContainer = function () {
            var Container = FocusZone;
        ...
        _this._renderToolboxLink = function (link) {
            ...
            var linkStyles = mergeStyles(ToolboxAutomationSelectors.toolTabClassName, isSelected ? _this._classNames.itemIsSelected : _this._classNames.item, link.className);
            return (React.createElement(CommandButton, __assign({}, headerButtonProps, { componentRef: _this.state.keyToRef[itemKey] || undefined, id: tabId, key: itemKey, className: linkStyles, onClick: !link.disabled && _this._onLinkClick.bind(_this, itemKey), onKeyPress: !link.disabled && _this._onKeyPress.bind(_this, itemKey), ariaLabel: link.ariaLabel, role: "tab", "aria-selected": _this.state.selectedKey === itemKey, name: link.headerText, title: link.headerText, keytipProps: link.keytipProps, disabled: link.disabled }),
        ...
        _this._renderLinkContent = function (link) {
            ...
            return (React.createElement("span", { className: _this._classNames.itemContent, "aria-hidden": true },
                itemIcon !== undefined && (React.createElement("span", { className: _this._classNames.iconContainer },
                    React.createElement(Icon, { iconName: itemIcon, className: _this._classNames.icon }))),
            ...
            return (React.createElement("div", { role: "tabpanel", "aria-labelledby": selectedTabId, className: _this._classNames.drawer, style: { width: _this.state.width } },
                React.createElement(React.Fragment, null,
                    React.createElement("div", { className: _this._classNames.drawerHeaderRegion },
                        ...
                        React.createElement(CommandButton, { className: mergeStyles(ToolboxAutomationSelectors.closeDrawerClassName, _this._classNames.drawerClose), onClick: _this._dismissDrawer, title: closeTitle },
                            React.createElement(Icon, { className: _this._classNames.drawerCloseIcon, iconName: "Cancel" }))),
                    selectedChild),
                _this.props.isResizable && (React.createElement(Resizer, { size: _this.state.width, onSizeChanged: function (newSize) { return _this.setState({ width: newSize }); }, location: ResizerLocation.Right }))));
        };
    ...
    var ToolboxBase_1;
    ToolboxBase = ToolboxBase_1 = __decorate([

...
import { ToolboxBase } from './Toolbox.base';
...
describe('Toolbox', function () {
    it('onSelectedItemChanged called with null on clicking the close icon', function () {
        ...
        var wrapper = mount(React.createElement(Toolbox, { onSelectedItemChanged: onSelectedItemChanged, selectedKey: "key", strings: strings },
            React.createElement(ToolboxItem, { headerText: 'header', itemIcon: "Product", itemKey: "key" })));
    ...
    it('onSelectedItemChanged called with correct parameters on clicking Toolbox Item (controlled)', function () {
        ...
        var onSelectedItemChanged = jest.fn();
        var wrapper = mount(React.createElement(Toolbox, { onSelectedItemChanged: onSelectedItemChanged, selectedKey: null, strings: strings },
            React.createElement(ToolboxItem, { headerText: 'item0header', itemIcon: "Cake", itemKey: "anotherKey" }),
            React.createElement(ToolboxItem, { headerText: testHeader, itemIcon: "Product", itemKey: myKey }),
            React.createElement(ToolboxItem, { headerText: disabledTabHeader, itemIcon: "Edit", itemKey: disabledTabKey, disabled: true })));
        // find the command button inside the toolbox item
        var commandButtons = wrapper.find(CommandButton);
    ...
    it('onSelectedItemChanged called with correct parameters on clicking Toolbox Item (uncontrolled)', function () {
        ...
        var disabledTabHeader = 'disabledHeader';
        var onSelectedItemChanged = jest.fn();
        var wrapper = mount(React.createElement(Toolbox, { onSelectedItemChanged: onSelectedItemChanged, strings: strings },
            React.createElement(ToolboxItem, { headerText: 'item0header', itemIcon: "Cake", itemKey: anotherKey }),
            React.createElement(ToolboxItem, { headerText: testHeader, itemIcon: "Product", itemKey: myKey }),
            React.createElement(ToolboxItem, { headerText: disabledTabHeader, itemIcon: "Edit", itemKey: disabledTabKey, disabled: true })));
        // find the command button inside the toolbox item
    ...
    it('onToggleExpandLinks called with correct parameters (controlled)', function () {
        ...
        var wrapper = mount(React.createElement(Toolbox, { onToggleExpandLinks: onToggleExpandLinks, expandLinks: false, strings: strings },
            React.createElement(ToolboxItem, { headerText: 'item0header', itemIcon: "Cake", itemKey: "anotherKey" })));
        // find the command button inside the toolbox item
        var linkButton = wrapper.find(CommandButton).first();
        expect(linkButton.props().onClick).toBeDefined();
        var preventDefaultFunction = jest.fn();
        // Expand links
        linkButton.props().onClick({ preventDefault: preventDefaultFunction });
    ...
    it('onToggleExpandLinks called with correct parameters (uncontrolled)', function () {
        var onToggleExpandLinks = jest.fn();
        var wrapper = mount(React.createElement(Toolbox, { onToggleExpandLinks: onToggleExpandLinks, expandLinksInitially: false, strings: strings },
            React.createElement(ToolboxItem, { headerText: 'item0header', itemIcon: "Cake", itemKey: "anotherKey" })));
        // find the command button inside the toolbox item
        var linkButton = wrapper.find(CommandButton).first();
        expect(linkButton.props().onClick).toBeDefined();
    ...
    it('toolbox link corresponds to keypress', function () {
        ...
        linkButton.props().onKeyPress({ preventDefault: preventDefaultFunction2, which: KeyCodes.a });
    ...
    describe('expand/collapse button', function () {
        describe('using expandCollapseTooltip', function () {
            var wrapper;
            beforeEach(function () {
                wrapper = mount(React.createElement(ToolboxBase, { strings: {
                        expandCollapseTooltip: 'expand/collapse',
                        expandTooltip: 'expand',
                        collapseTooltip: 'collapse',
                        closeTooltip: 'close'
                    } },
                    React.createElement(ToolboxItem, { headerText: 'item0header', itemIcon: "Cake", itemKey: "key0" })));
            });
            afterAll(function () { return wrapper.unmount(); });
            it('should start collapsed', function () {
                var expandCollapseButton = wrapper.find(CommandButton).first();
            ...
            it('should switch to expanded when button is clicked', function () {
                wrapper.find(CommandButton).first().props().onClick({
        ...
        describe('deprecated - using expandTooltip and collapseTooltip', function () {
            var wrapper;
            beforeEach(function () {
                wrapper = mount(React.createElement(ToolboxBase, { strings: { expandTooltip: 'expand', collapseTooltip: 'collapse', closeTooltip: 'close' } },
                    React.createElement(ToolboxItem, { headerText: 'item0header', itemIcon: "Cake", itemKey: "key0" })));
            });
            afterAll(function () { return wrapper.unmount(); });
            it('should start with expandTooltip', function () {
                var expandButton = wrapper.find(CommandButton).first();
            ...
            it('should switch to collapseTooltip when clicked', function () {
                ...
                wrapper.update();
                expect(wrapper.find(CommandButton).first().props().ariaLabel).toBe('collapse');
                expect(getState(wrapper).linksAreExpanded).toBe(true);
            });
        });
    });
    it('onRenderItem link', function () {
        ...
        var wrapper = mount(React.createElement(Toolbox, { strings: strings },
            React.createElement(ToolboxItem, { headerText: 'item0header', itemIcon: "Cake", itemKey: "key0", onRenderItemLink: onRenderLink })));
        expect(onRenderLink).toBeCalled();
        wrapper.unmount();
    });
    it('focus', function () {
        var wrapper = mount(React.createElement(ToolboxBase, { strings: strings },
            React.createElement(ToolboxItem, { headerText: 'item0header', itemIcon: "Cake", itemKey: "key0" })));
    ...
    it('initialSelectedKey', function () {
        var wrapper = mount(React.createElement(ToolboxBase, { initialSelectedKey: "key2", strings: strings },
            React.createElement(ToolboxItem, { headerText: 'header1', itemIcon: "Product", itemKey: "key1" }),
            React.createElement(ToolboxItem, { headerText: 'header2', itemIcon: "Product", itemKey: "key2" }),
            React.createElement(ToolboxItem, { headerText: 'header3', itemIcon: "Product", itemKey: "key3" })));
        expect(getState(wrapper).selectedKey).toEqual('key2');
        wrapper.unmount();
    });
    it('selectedKey has priority over initialSelectedKey', function () {
        var wrapper = mount(React.createElement(ToolboxBase, { initialSelectedKey: "key2", selectedKey: 'key3', strings: strings },
            React.createElement(ToolboxItem, { headerText: 'header1', itemIcon: "Product", itemKey: "key1" }),
            React.createElement(ToolboxItem, { headerText: 'header2', itemIcon: "Product", itemKey: "key2" }),
            React.createElement(ToolboxItem, { headerText: 'header3', itemIcon: "Product", itemKey: "key3" })));
    ...
    it('uses resizable correctly when true', function () {
        var wrapper = mount(React.createElement(ToolboxBase, { strings: strings, isResizable: true },
            React.createElement(ToolboxItem, { headerText: 'header', itemIcon: "Product", itemKey: "key" })));
        var resizer = wrapper.find(Resizer);
        expect(resizer.length).toEqual(1);
        wrapper.unmount();
    });
    it('uses resizable correctly when false', function () {
        var wrapper = mount(React.createElement(ToolboxBase, { strings: strings, isResizable: false },
            React.createElement(ToolboxItem, { headerText: 'header', itemIcon: "Product", itemKey: "key" })));
        var resizer = wrapper.find(Resizer);
    ...
    it('expandLinksInitially', function () {
        var wrapper = mount(React.createElement(ToolboxBase, { expandLinksInitially: true, strings: strings },
            React.createElement(ToolboxItem, { headerText: 'header', itemIcon: "Product", itemKey: "key" })));
        expect(getState(wrapper).linksAreExpanded).toEqual(true);
        wrapper.unmount();
    });
    it('expandLinks has priority over expandLinksInitially', function () {
        var wrapper = mount(React.createElement(ToolboxBase, { expandLinksInitially: true, expandLinks: false, strings: strings },
            React.createElement(ToolboxItem, { headerText: 'header', itemIcon: "Product", itemKey: "key" })));
        expect(getState(wrapper).linksAreExpanded).toEqual(false);
        wrapper.unmount();
    });
    it('selectedKey', function () {
        var wrapper = mount(React.createElement(ToolboxBase, { selectedKey: null, strings: strings },
            React.createElement(ToolboxItem, { headerText: 'header1', itemIcon: "Product", itemKey: "key1" }),
            React.createElement(ToolboxItem, { headerText: 'header2', itemIcon: "Product", itemKey: "key2" }),
            React.createElement(ToolboxItem, { headerText: 'header3', itemIcon: "Product", itemKey: "key3" })));
    ...
    it('expandLinks', function () {
        var wrapper = mount(React.createElement(ToolboxBase, { expandLinks: false, strings: strings },
            React.createElement(ToolboxItem, { headerText: 'header1', itemIcon: "Product", itemKey: "key1" }),
            React.createElement(ToolboxItem, { headerText: 'header2', itemIcon: "Product", itemKey: "key2" }),
            React.createElement(ToolboxItem, { headerText: 'header3', itemIcon: "Product", itemKey: "key3" })));
        expect(getState(wrapper).linksAreExpanded).toEqual(false);
    ...
    it.skip('Focus should return to tool link after closing drawer via "X" button', function () {
        var wrapper = mount(React.createElement(ToolboxBase, { expandLinks: false, strings: strings, selectedKey: "key2" },
            React.createElement(ToolboxItem, { headerText: 'header1', itemIcon: "Product", itemKey: "key1" }),
            React.createElement(ToolboxItem, { headerText: 'header2', itemIcon: "Product", itemKey: "key2" }),
            React.createElement(ToolboxItem, { headerText: 'header3', itemIcon: "Product", itemKey: "key3" })));
    ...
    it('Conditional toolbox items should render work', function () {
        var toolTabSelector = "button." + ToolboxAutomationSelectors.toolTabClassName;
        var wrapper = mount(React.createElement(ConditionalItemToolbox, { selectedKey: 'key1', showSecondItem: false, showThirdItem: false, disableThirdItem: false }));
    ...
    it('renders the custom toolbox links container if provided', function () {
        ...
        var Container = function (props) {
            return React.createElement(FocusZone, __assign({}, props, { id: containerId }));
        };
        var wrapper = mount(React.createElement(ToolboxBase, { strings: strings, isResizable: true, toolboxLinksContainerAs: Container },
            React.createElement(ToolboxItem, { headerText: 'header', itemIcon: "Product", itemKey: "key" })));
...
var ConditionalItemToolbox = /** @class */ (function (_super) {
    __extends(ConditionalItemToolbox, _super);
    ...
    ConditionalItemToolbox.prototype.render = function () {
        ...
        return (React.createElement(Toolbox, { expandLinks: false, strings: strings, selectedKey: selectedKey },
            React.createElement(ToolboxItem, { headerText: 'header1', itemIcon: "Product", itemKey: "key1" },
                React.createElement("div", { className: 'toolbox-item-1' }, 'Item 1')),
            showSecondItem && (React.createElement(ToolboxItem, { headerText: 'header2', itemIcon: "Product", itemKey: "key2" },
                React.createElement("div", { className: 'toolbox-item-2' }, 'Item 2'))),
            showThirdItem && (React.createElement(ToolboxItem, { headerText: 'header3', itemIcon: "Product", itemKey: "key3", disabled: disableThirdItem },

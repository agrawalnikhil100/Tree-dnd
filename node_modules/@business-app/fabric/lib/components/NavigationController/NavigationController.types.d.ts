...
export interface INavigationControllerProps extends IBaseProps<INavigationController> {
     ...
     */
    readonly children: (context: INavigationController) => Array<React.ReactElement<INavigationControllerViewProps>>;
    /**
     ...
     */
    onRenderHeader?(props: INavigationControllerProps, viewProps: INavigationControllerViewProps, context: INavigationController): JSX.Element;
    /**
     * Optional override for rendering the footer
     */
    onRenderFooter?(props: INavigationControllerProps, viewProps: INavigationControllerViewProps, context: INavigationController): JSX.Element;
}
export declare type INavigationControllerStyleProps = Required<Pick<INavigationControllerProps, 'theme'>>;

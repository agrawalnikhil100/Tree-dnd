...
var NavigationControllerBase = /** @class */ (function (_super) {
    __extends(NavigationControllerBase, _super);
        ...
        if (this.props.onRenderHeader) {
            ...
            headerElement = (React.createElement(React.Fragment, null,
                this.props.showBackButton && this.canGoBack() ? (React.createElement("span", { className: this._classNames.headerBackButton },
                    React.createElement(IconButton, { ariaLabel: this.props.backButtonAriaLabel, iconProps: {
                            iconName: 'Back',
                            styles: {
                                root: {
    ...
    NavigationControllerBase.prototype._renderFooter = function (viewProps) {
        ...
        if (viewProps.footerButtons) {
            var footerButtons = viewProps.footerButtons.map(function (props, i) {
                var buttonProps = __assign(__assign({ key: i }, props), { styles: __assign({ root: {
                            height: '32px',
                            minWidth: '84px',
                            marginRight: '8px',
                            borderRadius: '2px'
                        } }, props.styles) });
                return props.primary ? React.createElement(PrimaryButton, __assign({}, buttonProps)) : React.createElement(DefaultButton, __assign({}, buttonProps));
            });
    ...
    NavigationControllerBase.prototype._renderView = function (viewProps) {
        return (React.createElement("div", { className: this._classNames.bodyContainer },
            React.createElement(NavigationControllerView, __assign({}, viewProps))));
    };
    NavigationControllerBase.prototype._getViewProps = function (viewKey) {
        var view = find(this.props.children(this), function (child) { return isNavigationControllerView(child) && child.props.viewKey === viewKey; });
        if (view) {
            return view.props;
        }
        else {
    ...
    NavigationControllerBase = __decorate([
        customizable('NavigationController', ['theme', 'styles'])
    ], NavigationControllerBase);
    return NavigationControllerBase;
}(BaseComponent));
export { NavigationControllerBase };
var NavigationControllerViewType = React.createElement(NavigationControllerView).type;
/**

...
describe('FormTagPicker Unit Tests', function () {
    describe('Renders for all combinations of props', function () {
        ...
        it('Null name throws error', function () {
            ...
            var errorFunction = function () {
                ReactTestUtils.renderIntoDocument(React.createElement(Form, { onSubmit: undefined },
                    React.createElement(FormTagPicker, { inputKey: null, value: undefined, tagPickerProps: { onResolveSuggestions: function () { return []; } } })));
            };
        ...
        it('Null props still render', function () {
            wrapper = Enzyme.mount(React.createElement(Form, { onSubmit: undefined },
                React.createElement(FormTagPicker, { inputKey: "tag", value: undefined, tagPickerProps: { onResolveSuggestions: function () { return []; } } })));
        ...
        it('With initial value', function () {
            ...
            wrapper = Enzyme.mount(React.createElement(Form, { onSubmit: function (value) {
                ...
                React.createElement(FormTagPicker, { inputKey: "tag", tagPickerProps: { onResolveSuggestions: function () { return [option1, option2]; } }, value: [option2] })));
            expect(wrapper.find('.ms-BasePicker')).toBeTruthy();
    ...
    describe('TagPicker update tests', function () {
        ...
        var ExtendsTagPicker = /** @class */ (function (_super) {
            __extends(ExtendsTagPicker, _super);

 ...
 */
export declare function required(errorMessage: string): (value?: any | null) => string | undefined;
/**
 ...
 */
export declare function length(desiredLength: number, formatError: (length: number) => string): (value?: string | null) => string | undefined;
/**
 ...
 */
export declare function minLength(lengthBound: number, formatError: (length: number) => string): (value?: string | null) => string | undefined;
/**
 ...
 * @param formatError a callback which takes the values length and formats an appropriate error message for validation failed
 */
export declare function maxLength(lengthBound: number, formatError: (length: number) => string): (value?: string | null) => string | undefined;
/**
 ...
 * @param errorMessage Required error message to display
 */
export declare function regex(expression: RegExp, errorMessage: string): (value?: string | null) => string | undefined;
/**
 * Returns a validator that checks if a number is greater than the provided bound
 * @param bound The bound
 * @param formatError a callback which takes the length and formats an appropriate error message for validation failed
 */
export declare function minValue(bound: number, formatError: (length: number) => string): (value?: string | null) => string | undefined;
/**
 * Returns a validator that checks if a number is less than the provided bound
 * @param bound The bound
 * @param formatError a callback which takes the length and formats an appropriate error message for validation failed
 */
export declare function maxValue(bound: number, formatError: (length: number) => string): (value?: string | null) => string | undefined;
/**
 * Returns a validator that checks if a number is an integer
 * @param errorMessage Required error message to display
 */
export declare function isInteger(errorMessage: string): (value?: string | null) => string | undefined;
/**
 * Returns a validator that ensures the value is a number
 * @param errorMessage Required error message to display
 */
export declare function isNumber(errorMessage: string): (value?: string | null) => string | undefined;
/**
 * Returns a validator that ensures the value is a URL
 * @param errorMessage Required error message to display
 */
export declare function isURL(errorMessage: string): (value?: string | null) => string | undefined;

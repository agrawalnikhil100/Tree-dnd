...
export var defaultColorPickerStyles = {
    root: {
        marginTop: 2
    }
};
export var defaultTooltipIconStyles = {
    root: {
        fontSize: 12,
        width: 12,
        height: 12,
...
export var defaultTooltipIconProps = {
    iconProps: {
        iconName: 'Info',
        styles: {
            defaultTooltipIconStyles: defaultTooltipIconStyles
        }
    }
};

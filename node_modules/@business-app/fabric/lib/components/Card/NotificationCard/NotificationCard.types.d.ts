...
declare type ConditionalNotificationProps = {
...
export declare type NotificationCardProps = BaseNotificationCardProps & ConditionalNotificationProps;
export declare type NotificationCardStyleProps = Pick<NotificationCardProps, 'theme' | 'className' | 'notificationType' | 'isNew'>;

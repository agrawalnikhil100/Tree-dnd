...
import { BaseComponent, classNamesFunction, customizable, find, findIndex } from '@fluentui/react/lib/Utilities';
import { FilterSearchBox } from '../FilterSearchBox';
var getClassNames = classNamesFunction();
var allFilterItemDefaultKey = 'filterSearchViewsAllFilterKey';
var allFilterItemText = 'All';
export var defaultFilterIconNameFunction = function (selectedFilterKey) {
    return selectedFilterKey === null ? 'Filter' : 'FilterSolid';
};
var FilterSearchViewsBase = /** @class */ (function (_super) {
    __extends(FilterSearchViewsBase, _super);
    function FilterSearchViewsBase(props) {
        ...
        _this._onClickViewPickerIcon = function () {
            ...
            _this.setState(function (prev) {
                ...
                var index = findIndex(views, function (view) { return view.key === prev.selectedViewKey; });
    ...
    FilterSearchViewsBase.prototype.componentDidUpdate = function () {
        ...
        var selectedView = find(this.props.views, function (view) { return view.key === _this.state.selectedViewKey; });
        if (!selectedView) {
            this.setState({
    ...
    Object.defineProperty(FilterSearchViewsBase.prototype, "_selectedView", {
        get: function () {
            ...
            return find(views, function (view) { return view.key === selectedViewKey; }) || null;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(FilterSearchViewsBase.prototype, "_selectedFilter", {
        get: function () {
            ...
            if (filters) {
                return find(filters, function (filter) { return filter.key === selectedFilterKey; }) || null;
            }
            return null;
        },
        enumerable: false,
    ...
    FilterSearchViewsBase.prototype._renderSearchBoxAndViewToggle = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement("div", { className: this._classNames.searchBoxViewPickerContainer },
                React.createElement(FilterSearchBox, { componentRef: this._filterSearchBoxRef, strings: {
    ...
    FilterSearchViewsBase.prototype._renderViewPicker = function () {
        ...
        return (React.createElement(IconButton, { styles: { root: this._classNames.viewPickerButton }, iconProps: { iconName: selectedView === null || selectedView === void 0 ? void 0 : selectedView.iconName }, onClick: onClick, menuProps: menuProps, ariaLabel: selectedView === null || selectedView === void 0 ? void 0 : selectedView.ariaLabel, title: selectedView === null || selectedView === void 0 ? void 0 : selectedView.ariaLabel }));
    };

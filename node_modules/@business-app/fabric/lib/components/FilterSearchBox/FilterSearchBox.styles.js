...
export var getStyles = function (props) {
    ...
    return {
        ...
        filterButtonRoot: __assign(__assign({}, sharedButtonRootStyles), { minWidth: 0, maxWidth: '50%' }),
        filterButtonRootInTooltipHost: __assign(__assign({}, sharedButtonRootStyles), { width: '100%', maxWidth: '100%' }),
        filterButtonLabel: {
            fontWeight: 400,
